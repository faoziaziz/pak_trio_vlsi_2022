...
HD_PWD='C:/repo/kuliah/vlsi/imregin_max/imregin_max.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log matrix_to_matrix.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source matrix_to_matrix.tcl
