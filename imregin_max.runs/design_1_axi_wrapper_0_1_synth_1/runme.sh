...
HD_PWD='C:/repo/kuliah/vlsi/imregin_max/imregin_max.runs/design_1_axi_wrapper_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_wrapper_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_wrapper_0_1.tcl
